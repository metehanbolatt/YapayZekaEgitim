...
class AnimAIQuizGameFragment : Fragment() {
    ...
    private var _binding : FragmentAnimAIQuizGameBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAnimAIQuizGameBinding.inflate(inflater, container, false)
        ...
        binding.aiQuizCard.animation = anim

        Handler(Looper.getMainLooper()).postDelayed({
            navController = findNavController()
            navController.navigate(R.id.action_animAIQuizGameFragment_to_AIGameTwoFragment)
        },2000)
